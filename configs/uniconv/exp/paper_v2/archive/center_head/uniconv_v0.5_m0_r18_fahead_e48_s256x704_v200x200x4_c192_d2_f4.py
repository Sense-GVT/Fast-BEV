...
model = dict(
    ...
    neck_3d=dict(
        ...
        stride=2,
        is_transpose=False,
        fuse=dict(in_channels=64*4*4, out_channels=256),
        norm_cfg=dict(type='SyncBN', requires_grad=True)),
    seg_head=None,
    bbox_head=dict(
        ...
        transforms=[
            dict(
                ...
                file_client_args=dict(
                    ...
                    path_mapping=dict({
                        './data/nuscenes/':
                        'public-1424:s3://openmmlab/datasets/detection3d/nuscenes/'
                    })))
        ]),
    dict(
        type='LoadPointsFromFile',
...
work_dir = 'work_dirs/uniconv/exp/paper_v2/uniconv_v0.5_m0_r18_fahead_e48_s256x704_v200x200x4_c192_d2_f4'
gpu_ids = range(0, 32)
