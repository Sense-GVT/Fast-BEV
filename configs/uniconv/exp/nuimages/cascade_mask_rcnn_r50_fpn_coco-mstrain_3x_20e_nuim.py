...
log_level = 'INFO'
work_dir = None
load_from = 'http://download.openmmlab.sensetime.com/mmdetection/v2.0/cascade_rcnn/cascade_mask_rcnn_r50_fpn_mstrain_3x_coco/cascade_mask_rcnn_r50_fpn_mstrain_3x_coco_20210628_164719-5bdc3824.pth'  # noqa
resume_from = None
workflow = [('train', 1)]
