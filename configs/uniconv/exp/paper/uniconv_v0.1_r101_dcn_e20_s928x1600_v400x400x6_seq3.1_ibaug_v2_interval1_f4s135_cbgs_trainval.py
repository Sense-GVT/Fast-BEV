...
model = dict(
    ...
    neck=dict(
        ...
        out_channels=96,
        num_outs=4),
    neck_fuse=dict(in_channels=96*4, out_channels=96),
    neck_3d=dict(
        type='M2BevNeck',
        in_channels=96*6*4,
        out_channels=256,
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            with_box2d=True,
            box_type_3d='LiDAR',
            ann_file='data/nuscenes/nuscenes_infos_trainval_4d_interval3_max60.pkl',
            load_interval=1,
            sequential=True,
            n_times=4,
            train_adj_ids=[1, 3, 5],
...
load_from = 'pretrained_models/cascade_mask_rcnn_r101_dcn_fpn_coco-mstrain_3x_20e_nuim_bbox_mAP_0.5470_segm_mAP_0.4370.pth'
resume_from = None
workflow = [('train', 1)]
