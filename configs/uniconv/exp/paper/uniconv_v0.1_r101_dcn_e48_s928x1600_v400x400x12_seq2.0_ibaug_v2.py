...
train_pipeline = [
    dict(type='MultiViewPipeline', sequential=True, n_images=6, transforms=[
        dict(
...
# load_from = None
load_from = 'https://download.openmmlab.com/mmdetection3d/v0.1.0_models/nuimages_semseg/cascade_mask_rcnn_r101_fpn_1x_nuim/cascade_mask_rcnn_r101_fpn_1x_nuim_20201024_134804-45215b1e.pth'
resume_from = None
workflow = [('train', 1)]
